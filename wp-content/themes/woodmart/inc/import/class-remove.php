...
class Remove extends Singleton {
	...
	public function interface() {
		...
		<div class="xts-popup-holder wd-import-remove">
			<a href="#" class="xts-popup-opener wd-import-remove-opener xts-bordered-btn xts-bordered-btn-white">
	...
	public function popup_content( $ajax, $action ) {
		...
		<form class="wd-import-remove-form" method="post" action="#">
			<div class="wd-import-select-btns">
				<button class="xts-inline-btn  wd-import-remove-select">
					<?php esc_html_e( 'Check all', 'woodmart' ); ?>
				</button>

				<button class="xts-inline-btn  wd-import-remove-deselect">
			...
			<div class="wd-import-remove-alert">
				...
				<button type="submit" class="wd-import-remove-btn xts-btn xts-btn-disable">
